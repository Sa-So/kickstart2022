...
int main() {
    ...
    for(int tt=1;tt<=t;tt++){
        ...
        string s2=s;
        int loc_idx = 0;
        for(int i=0;i<pow(2,loc.size()+1);i++){
            ...
            // cout<<endl;
            // loc_idx++;
            // if(CountPS(s2,s2.length())-CountPS4(s2,s2.length()) == 0){
            //     flag=1;
            //     break;
            // }
            if(longestPalSubstr(s2)<5){
                // cout<<"*"<<s2<<endl;
                flag=1;
                break;
            }
